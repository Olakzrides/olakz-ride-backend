  ...
  apps: [
    {
      ...
      env: {
        ...
        CAR_WASH_SERVICE_URL: 'http://localhost:3010',
        AUTO_MECH_SERVICE_URL: 'http://localhost:3011',
        LOG_LEVEL: 'info'
      },
      instances: 1,
      exec_mode: 'fork',
    ...
    },
    {
      ...
      script: './services/car-wash-service/dist/index.js',
      cwd: '/home/deploy/olakz-ride-backend',
      env: {
        NODE_ENV: 'production',
        PORT: 3010,
        ...
        SUPABASE_ANON_KEY: 'your-supabase-anon-key-here',
        SUPABASE_SERVICE_ROLE_KEY: 'your-service-role-key-here',
        SUPABASE_STORAGE_BUCKET: 'car-wash',
      ...
      watch: false,
      max_memory_restart: '1G',
      error_file: './logs/car-wash-service-error.log',
      out_file: './logs/car-wash-service-out.log',
      log_file: './logs/car-wash-service-combined.log',
      time: true,
      merge_logs: true,
      restart_delay: 4000,
      max_restarts: 10,
    ...
    {
      name: 'auto-mech-service',
      script: './services/auto-mech-service/dist/index.js',
      cwd: '/home/deploy/olakz-ride-backend',
      env: {
        NODE_ENV: 'production',
        PORT: 3011,
        ...
        SUPABASE_ANON_KEY: 'your-supabase-anon-key-here',
        SUPABASE_SERVICE_ROLE_KEY: 'your-service-role-key-here',
        SUPABASE_STORAGE_BUCKET: 'auto-mech',
        CORE_LOGISTICS_SERVICE_URL: 'http://localhost:3001',
        AUTH_SERVICE_URL: 'http://localhost:3003',
        ALLOWED_ORIGINS: 'https://olakzride.duckdns.org,http://localhost:3000',
        LOG_LEVEL: 'info'
      ...
      watch: false,
      max_memory_restart: '1G',
      error_file: './logs/auto-mech-service-error.log',
      out_file: './logs/auto-mech-service-out.log',
      log_file: './logs/auto-mech-service-combined.log',
      time: true,
      merge_logs: true,
      restart_delay: 4000,
      max_restarts: 10,
