...
export class CategoryController {
  ...
  /**
   * GET /api/auto-mech/vendor/categories
   */
  getMyCategories = async (req: Request, res: Response): Promise<Response> => {
    const user = (req as AuthRequest).user!;
    try {
      const { data: vendor } = await supabase
        .from('auto_mech_vendors').select('id').eq('user_id', user.id).single();
  ...
  /**
   * GET /api/auto-mech/vendor/categories/all
   */
  ...
  /**
   * GET /api/auto-mech/vendor/categories/grouped
   */
  ...
  /**
   * POST /api/auto-mech/vendor/categories
   */
  ...
  /**
   * PATCH /api/auto-mech/vendor/categories/:categoryId
   */
  ...
  /**
   * DELETE /api/auto-mech/vendor/categories/:categoryId
   */
  ...
  /**
   * PATCH /api/auto-mech/vendor/services/:serviceId/category
   */
