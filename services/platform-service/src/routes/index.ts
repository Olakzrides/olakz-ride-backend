...
import vendorRegistrationRoutes from './vendor-registration.routes';
...
export function setupRoutes(app: Application): void {
  ...
  // Vendor registration (platform-wide: restaurant, marketplace, carwash, mechanics)
  app.use('/api/vendor', vendorRegistrationRoutes);
