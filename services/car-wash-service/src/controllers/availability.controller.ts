...
export class AvailabilityController {
  ...
  /**
   * GET /api/auto-wash/vendors/:vendorId/services/:serviceId/availability
  ...
  /**
   * GET /api/auto-wash/vendors/:vendorId/services/:serviceId/availability/multi
   * Returns availability for the next N days.
