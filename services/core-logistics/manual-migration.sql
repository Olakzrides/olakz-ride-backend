-- Manual Migration: Add missing columns and function safely
-- Run this in Supabase SQL Editor

-- 1. Add missing columns to rides table (if they don't exist)
...
BEGIN
    IF NOT EXISTS (
        ...
        WHERE constraint_name = 'fk_rides_payment_hold'
    ) THEN
...
-- 3. Add indexes for performance (if not exists)
...
-- 4. Create the atomic ride creation function
