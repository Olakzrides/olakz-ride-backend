...
export class MapsUtil {
  ...
  static extractStateFromAddress(address: string): string | null {
    ...
    const cityToState: Record<string, string> = {
      ...
      'ifako':           'Lagos',
      'fagba':           'Lagos',
      'cement':          'Lagos',   // Cement bus stop
      'abule egba':      'Lagos',
      'abule-egba':      'Lagos',
      'meiran':          'Lagos',
      'akute':           'Lagos',   // borders Lagos/Ogun but mostly Lagos
      'ojokoro':         'Lagos',
      'alakuko':         'Lagos',
      'sango':           'Lagos',   // Sango-Ota area (note: also in Ogun — Lagos wins for ride purposes)
      'iyano':           'Lagos',
      ...
      'agodi':           'Oyo',
      'bodija':          'Oyo',
      'ring road':       'Oyo',     // Ibadan ring road
      'iyaganku':        'Oyo',
      'molete':          'Oyo',
      'sango ibadan':    'Oyo',
      'eleyele':         'Oyo',
